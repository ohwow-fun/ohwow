...
export function SplashStep({ businessName, loading, error }: SplashStepProps) {
    ...
    <Box flexDirection="column">
      ...
      {loading ? (
        ...
        <>
          ...
          <Box marginTop={1}>
            <Text color="gray">Press <Text bold color="white">Enter</Text> to enter your key manually</Text>
          </Box>
        </>
      ) : (
        <>
