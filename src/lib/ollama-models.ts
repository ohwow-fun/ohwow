...
export interface OllamaModelInfo {
  ...
  minRAM: number;
  features: string[];
  /** Model family (qwen, llama, gemma, mistral, deepseek) */
  family: string;
...
export const MODEL_CATALOG: OllamaModelInfo[] = [
  ...
  },
  {
    ...
    description: 'Lightweight vision model. Reads images on any machine.',
    sizeGB: 1.0,
    minRAM: 4,
  ...
  },
  {
    ...
    description: 'IBM\'s doc understanding model. Tables, charts, and images.',
    sizeGB: 1.5,
    minRAM: 4,
    features: ['text', 'vision', '4K context'],
    family: 'granite',
    tier: 'small',
    vision: true,
    contextSize: 4_096,
  ...
  },
  {
    tag: 'llama3.2:8b',
    label: 'Llama 3.2 8B',
    description: 'Meta\'s workhorse model. Solid all-around performance.',
    sizeGB: 4.7,
    minRAM: 8,
    features: ['text', '128K context'],
    family: 'llama',
  ...
  },
  {
    tag: 'mistral:7b',
    label: 'Mistral 7B',
    description: 'Fast European model. Great for structured tasks.',
    sizeGB: 4.1,
    minRAM: 8,
    features: ['text', '32K context'],
    family: 'mistral',
  ...
  },
  {
    tag: 'llama3.3:14b',
    label: 'Llama 3.3 14B',
    description: 'Meta\'s powerful model. Excellent quality.',
    sizeGB: 9.0,
    minRAM: 16,
    features: ['text', '128K context'],
    family: 'llama',
  ...
  },
  {
    ...
    description: 'Beats GPT-4o mini on vision tasks. Strong image analysis.',
    sizeGB: 5.0,
    minRAM: 16,
    features: ['text', 'vision', '32K context'],
    family: 'minicpm',
    tier: 'large',
    vision: true,
    contextSize: 32_768,
