...
export function buildVoicePrinciples(): string {
  return [
    ...
    '  - NEVER narrate the movement at the category level ("AI tools are',
    '    becoming X", "this is a shift toward Y", "the industry is moving',
    '    to Z"). Name the specific actor and the specific change.',
    '    Category-labeling is the default output of a model that has',
    '    evidence but no angle.',
    ...
    '    empower/empowered/empowering, dive into, unlock, revolutionize,',
    '    thought leader, in today\'s world, it\'s important to note,',
    '    it is important to note, i wanted to reach out, i hope this,',
    '    touch base, circle back.',
    '  - OUTREACH DM RULES:',
    '    - No "Hey [Name]" opener — marks automated outreach immediately.',
    '    - No filler bridges: "I thought you might be interested",',
    '      "I came across your profile", "I wanted to reach out".',
    '    - First sentence names the specific thing — the post, the problem,',
    '      the observation — not the contact.',
    '    - Subject lines (email) must be under 50 chars and must not contain',
    '      the word "note".',
    '    - No trailing period after the final sentence in short messages',
