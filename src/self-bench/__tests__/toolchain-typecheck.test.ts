...
import { ToolchainTypecheckExperiment } from '../experiments/toolchain-typecheck.js';
...
describe('ToolchainTypecheckExperiment (auto-generated)', () => {
  const exp = new ToolchainTypecheckExperiment();
  ...
  it('returns pass when command exits 0', async () => {
    ...
    expect(ev.command).toBe('npm run typecheck');
  });
