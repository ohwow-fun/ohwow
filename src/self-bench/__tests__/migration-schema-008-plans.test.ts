...
import { MigrationSchema008PlansExperiment } from '../experiments/migration-schema-008-plans.js';
...
const EXPECTED = ['agent_workforce_plans', 'agent_workforce_plan_steps'];

describe('MigrationSchema008PlansExperiment (auto-generated)', () => {
  const exp = new MigrationSchema008PlansExperiment();
