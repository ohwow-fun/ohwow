...
import { ToolchainTestsExperiment } from '../experiments/toolchain-tests.js';
...
describe('ToolchainTestsExperiment (auto-generated)', () => {
  const exp = new ToolchainTestsExperiment();
