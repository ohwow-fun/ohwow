...
async function plumbCostToPhaseReports(
  ...
  for (const r of reports) {
    await updatePhaseReport(db, {
      ...
      delta_ledger_json: r.delta_ledger_json != null ? JSON.stringify(r.delta_ledger_json) : null,
      inbox_added_json: r.inbox_added_json != null ? JSON.stringify(r.inbox_added_json) : null,
